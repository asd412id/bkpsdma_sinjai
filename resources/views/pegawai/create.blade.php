        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            ...
            <div class="row form-group">
              ...
              <div class="col-sm-12">
                ...
                <select class="form-control" name="jenis_kelamin">
                  @foreach ($jk as $key => $p)
                    <option {{ old('jenis_kelamin')==$key?'selected':'' }} value="{{ $key }}">{{ ucwords($p) }}</option>
                  @endforeach
                </select>
              </div>
            </div>
            <div class="row form-group">
              ...
              <div class="col-sm-12">
                <textarea name="alamat" rows="8" cols="80" class="form-control">{{ old('alamat') }}</textarea>
              </div>
            </div>
            <div class="row form-group">
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            <div class="row form-group">
              ...
              <div class="col-sm-12">
                <input type="number" name="nip_baru" class="form-control" value="{{ old('nip_baru') }}">
              </div>
            </div>
            <div class="row form-group">
              <label for="" class="control-label col-sm-12">NIP Lama</label>
              <div class="col-sm-12">
                <input type="number" name="nip_lama" class="form-control" value="{{ old('nip_lama') }}">
              </div>
            </div>
            <div class="row form-group">
              ...
              <div class="col-sm-12">
                <select class="form-control" name="golongan">
                  @foreach ($pg as $key => $p)
                    <option {{ old('golongan')==$p?'selected':'' }} value="{{ $p }}">{{ $p }}</option>
                  @endforeach
                </select>
              </div>
            </div>
            ...
            <div class="row form-group">
              ...
              <div class="col-sm-12">
                <input type="text" name="instansi_induk" class="form-control" value="{{ old('instansi_induk') }}" required>
              </div>
            </div>
            <div class="row form-group">
              <label for="" class="control-label col-sm-12">Status</label>
              <div class="col-sm-12">
                <input type="text" name="status" class="form-control" value="{{ old('status')??'Aktif' }}" required>
              </div>
            </div>
          </div>
        </div>
